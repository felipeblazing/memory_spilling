...
struct table_allocation {
    spilling::fixed_size_host_memory_resource::multiple_blocks_allocation allocation;
    std::unique_ptr<std::vector<uint8_t>> metadata;
    std::size_t data_size;
    
    table_allocation(spilling::fixed_size_host_memory_resource::multiple_blocks_allocation alloc,
...
public:
     ...
     */
    static spilling::table_allocation
     ...
     */
    static cudf::table recreate_table(const spilling::table_allocation& table_alloc, 
                                     rmm::cuda_stream_view stream);
...
private:
     ...
     */
    static spilling::fixed_size_host_memory_resource::multiple_blocks_allocation 
